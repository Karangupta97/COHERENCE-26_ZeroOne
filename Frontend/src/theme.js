...
export function ThemeSwitcher() {
  const { colors, fonts, mode, themeKey, switchTheme, toggleMode, themes } = useTheme();
      ...
      <div style={{ display: "flex", gap: "6px", alignItems: "center" }}>
        {Object.entries(themes).map(([key, t]) => (
          <button
            ...
            style={{
              width:        themeKey === key ? "28px" : "20px",
              height:       themeKey === key ? "28px" : "20px",
              borderRadius: "50%",
              border:       themeKey === key
              ...
              padding:      0,
              fontSize:     themeKey === key ? "12px" : "10px",
              display:      "flex",
              alignItems:   "center",
