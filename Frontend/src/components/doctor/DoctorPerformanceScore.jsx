...
const SCORE_DATA = {
    overall: 78,
    categories: [
        { label: 'Approval Speed', score: 85, icon: '⚡', tip: 'Avg 1.2 days to review' },
        { label: 'Match Conversion', score: 72, icon: '🔗', tip: '7 of 12 matches approved' },
        { label: 'Enrollment Rate', score: 68, icon: '🎯', tip: '2 of 7 approved enrolled' },
        { label: 'Trial Coverage', score: 90, icon: '🧪', tip: 'Active in 5 trial domains' },
    ]
}
